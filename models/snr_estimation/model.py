    ...
    def __init__(
        ...
        **kwargs
        ...
        if os.path.exists(inp_tgt_obj_path) and not reset_inp_tgt:
            ...
            print('This file does not exists: %s' % (inp_tgt_obj_path))
